...
std::vector<PieceManager::PieceSpawn> PieceManager::CreateInitialLayout() {
    std::vector<PieceSpawn> layout = {
        ...
        {"QUEEN_WHITE", PieceType::Queen, PieceColor::White, "QUEEN_WHITE.obj", "D1"},
        {"KING_WHITE", PieceType::King, PieceColor::White, "KING_WHITE.obj", "E1"},
        ...
        {"QUEEN_BLACK", PieceType::Queen, PieceColor::Black, "QUEEN_BLACK.obj", "D8"},
        {"KING_BLACK", PieceType::King, PieceColor::Black, "KING_BLACK.obj", "E8"},
